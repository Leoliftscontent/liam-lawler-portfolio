...
export const projects: Project[] = [
  ...
  },
  {
    ...
    thumbnail: "/images/acting-bfa-2025-showcase/thumbnail/acting-bfa-2025-showcase-thumbnail.png",
    gallery: [],
    behindTheScenes: [],
    ...
    credits: [],
    roles: ["Gaffer"],
    client: "Spring 2025 Acting BFA Senior Showcase",
    year: "2025",
    tags: ["Behind the Scenes", "Gaffing", "Lighting"],
    description:
      "Behind-the-scenes photography and on-set documentation from the Spring 2025 Acting BFA senior showcase production. I worked as a gaffer, helping with lighting setups, production support, and on-set collaboration throughout the course.",
    cardDescription:
      "Behind-the-scenes photography and lighting work from the Spring 2025 Acting BFA senior showcase production.",
    awards: [],
    externalLinks: [],
